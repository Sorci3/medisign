"""
MediSign Assist — Real-time sign language inference (TCN baseline, 02_tcn_training)
====================================================================================
Utilise le modèle TCN non pré-entraîné (tcn_medisign_final.pth).
Architecture identique à 02_tcn_training : 4 blocs, hidden=128, avg pooling.

Usage:
    python src/utils/inference_baseline.py
...
# Architecture du notebook 02_tcn_training : 4 blocs, hidden=128, avg pooling
...
def main():
    ...
    with mp_vision.HolisticLandmarker.create_from_options(options) as landmarker:
        while True:
            ...
            cv2.imshow("MediSign — TCN Baseline (02_tcn_training)", frame)
